...
public interface ColumnMappingRemoteService {
    ...
    List<DsColumnMappingModel> getListInfoBySourceName(String sourceName);
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "id值", required = true, dataType = "int", paramType = "query",example = "0"),
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "id", required = true, dataType = "int", paramType = "query",example = "0"),
            @ApiImplicitParam(name = "targetTable", value = "目标表名", required = true, dataType = "String", paramType = "query"),
            @ApiImplicitParam(name = "source", value = "源(表名/URL)", required = true, dataType = "String", paramType = "query"),
