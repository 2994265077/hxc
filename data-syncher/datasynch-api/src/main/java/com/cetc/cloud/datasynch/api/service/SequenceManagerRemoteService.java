...
public interface SequenceManagerRemoteService {
    ...
    @RequestMapping(value = "/sequences/create/bySeqName", produces = "application/json", method = RequestMethod.POST)
    @ApiOperation(value = "创建序列", notes = "", produces = "application/json")
