...
public interface CommonInstance {
    ...
    String DEFAULT_FILE_OUTPUTPATH = "C:\\Users\\Administrator\\Desktop\\";
    /**
     * 数据接入方式：
     * 0：数据库方式
     * 1：接口方式
     */
    public static final int ACCESS_TYPE_DB = 0;
    public static final int ACCESS_TYPE_INTERFACE = 1;
    ...
    int HTTP_CONNECT_TIMEOUT = 15000;//默认获取连接超时
     ...
     * 接口方式分页参数占位符名称
     */
    String PAGE_NUM_replaceholder = "\\$1\\$";
    String PAGE_SIZE_replaceholder = "\\$2\\$";
     ...
     * 分页参数组织类型
     */
    int HTTP_PAGING_TYPE_PageNum_PageSize = 1;          //一般类型：pageNum=1&pageSize=100
    int HTTP_PAGING_TYPE_StartPosition_MaxCount = 2;    //安监接口类型:page={"pagenum":"1","pagesize":"50" }
    ...
    int NO_SIGN = 0;
    /*
        需要签名，且签名类型为 时间戳+secretKey
     */
    int SIGN_TYPE_TIMESTAMP_SECRETKEY = 1;
    ...
    String JOB_update_financialFutian = "update_financialFutian";
    String JOB_add_traffic_info = "add_traffic_info";
    ...
    /**
     * 定义解析URL+httpParams返回时key的统一名称
     */
    String HTTP_URL_KEY_NAME = "HTTP_URL_KEY_NAME";
    String HTTP_QUERY_PARAMS_KEY_NAME = "HTTP_QUERY_PARAMS_KEY_NAME";


    String DATE_TIME_STANDARD_FORMAT = "yyyy-MM-dd HH:mm:ss";
}
