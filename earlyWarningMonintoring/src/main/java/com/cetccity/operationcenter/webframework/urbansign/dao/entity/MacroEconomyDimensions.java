...
public enum MacroEconomyDimensions {
    ...
    CITY_INVESTMENT                     ("深圳各区R&D经费投入比较",                "", "city_investment"),
    CITY_INVESTMENT_SP                  ("深圳各区R&D经费及比重",                  "深圳各区R&D经费及比重", "city_investment_sp"),
    REGION_INVESTMENT_LEVEL             ("福田历年R&D投入强度情况",                 "", "region_investment_level"),
    ...
    REGION_INVESTMENT_STAFF             ("福田历年R&D人数变化情况",                 "", "region_investment_staff"),
    REGION_INVESTMENT_PATENTS           ("福田历年专利申请量变化情况",               "", "region_investment_patents"),
