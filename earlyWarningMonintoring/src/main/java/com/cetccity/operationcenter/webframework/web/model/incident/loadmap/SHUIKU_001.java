...
public class SHUIKU_001 implements Serializable {
    private Integer id;
    ...
    private String sjngsl;

    private String skgldw;
    ...
    public void setSkbh(String skbh) {
        this.skbh = skbh == null ? null : skbh.trim();
    }
    ...
    public void setSkmc(String skmc) {
        this.skmc = skmc == null ? null : skmc.trim();
    }
    ...
    public void setZkr(String zkr) {
        this.zkr = zkr == null ? null : zkr.trim();
    }

    public String getXlkr() {
        return xlkr;
    }

    public void setXlkr(String xlkr) {
        this.xlkr = xlkr == null ? null : xlkr.trim();
    }

    public String getSjngsl() {
        return sjngsl;
    }

    public void setSjngsl(String sjngsl) {
        this.sjngsl = sjngsl == null ? null : sjngsl.trim();
    }

    public String getSkgldw() {
        return skgldw;
    }

    public void setSkgldw(String skgldw) {
        this.skgldw = skgldw == null ? null : skgldw.trim();
    }
