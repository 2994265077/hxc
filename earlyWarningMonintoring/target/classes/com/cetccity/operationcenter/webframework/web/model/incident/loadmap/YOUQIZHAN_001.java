...
public class YOUQIZHAN_001 implements Serializable {
    private Integer id;

    private String uuid;

    private String yqzmc;

    private String yqzbh;
    ...
    public String getYqzmc() {
        return yqzmc;
    }

    public void setYqzmc(String yqzmc) {
        this.yqzmc = yqzmc == null ? null : yqzmc.trim();
    }

    public String getYqzbh() {
        return yqzbh;
    }

    public void setYqzbh(String yqzbh) {
        this.yqzbh = yqzbh == null ? null : yqzbh.trim();
    }
