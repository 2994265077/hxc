...
public class TB_WEIJI_IN_INFO_RT implements Serializable {
    private Integer id;
    ...
    private Integer admitNo;

    private Integer leaveHNo;

    private Integer inHNo;
    ...
    public Integer getAdmitNo() {
        return admitNo;
    }

    public void setAdmitNo(Integer admitNo) {
        this.admitNo = admitNo;
    }

    public Integer getLeaveHNo() {
        return leaveHNo;
    }

    public void setLeaveHNo(Integer leaveHNo) {
        this.leaveHNo = leaveHNo;
    }

    public Integer getInHNo() {
        return inHNo;
    }

    public void setInHNo(Integer inHNo) {
        this.inHNo = inHNo;
    }
