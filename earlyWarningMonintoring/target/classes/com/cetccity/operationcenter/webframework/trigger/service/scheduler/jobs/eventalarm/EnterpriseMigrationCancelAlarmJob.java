...
@Component
@Slf4j
public class EnterpriseMigrationCancelAlarmJob {
    ...
    public void execute() {
        enterpriseMigrationAlarmTriggerService.cancelAlarmTrigger(enterpriseMigrationAlarmTriggerService.getOriginTableName());
    }
}
